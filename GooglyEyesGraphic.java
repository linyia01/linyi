...
class GooglyEyesGraphic extends GraphicOverlay.Graphic {
    private static final float EYE_RADIUS_PROPORTION = 0.25f;
    ...
    private volatile boolean isSmile;
    ...
    void updateEyes(PointF leftPosition, boolean leftOpen,
                    PointF rightPosition, boolean rightOpen,boolean issmile) {
    ...
    private void drawEye(Canvas canvas, PointF eyePosition, float eyeRadius,
        ...
        if (isSmile){
            ...
            dd.setStrokeWidth(25);
            dd.setTextSize(50);
            dd.setTypeface(Typeface.SANS_SERIF);
            canvas.drawText("笑笑",eyePosition.x-100,eyePosition.y+500,dd);
        }
